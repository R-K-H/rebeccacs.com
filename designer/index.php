        ...
        <ul class="slides">
            <li class="overlay image-bg">
                <div class="background-image-holder">
                    <img alt="image" class="background-image" src="../assets/img/home22.jpg">
                </div>
...
<section id="variant-slider-11" class="vim" vbp="slider" vbr="Slider w/ More Text">
    <section class="image-slider slider-all-controls controls-inside parallax pt0 pb0 height-70">
        <ul class="slides">
            <li class="overlay image-bg">
                <div class="background-image-holder">
                    <img alt="image" class="background-image" src="../assets/img/home-2-8.jpg">
                </div>
                <div class="container v-align-transform">
...
<section id="variant-slider-2" class="vim" vbp="header,fullscreen,video" vbr="Embed Video Modal" icons="youtube-vimeo">
    <section class="fullscreen cover parallax image-bg overlay">
        <div class="background-image-holder">
            <img alt="image" class="background-image" src="../assets/img/home-2-1.jpg">
        </div>
        <div class="container v-align-transform">
            <div class="row">
...
<section id="variant-slider-12" class="vim" vbp="header,fullscreen" vbr="Image & Paragraph">
    <section class="cover fullscreen image-slider slider-arrow-controls controls-inside parallax">
        <ul class="slides">
            <li class="overlay image-bg">
                <div class="background-image-holder">
                    <img alt="image" class="background-image" src="../assets/img/cover7.jpg">
                </div>
                <div class="container v-align-transform">
                    <div class="row">
                        <div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2 text-center">
                            <img alt="Logo" class="image-small mb8" src="../assets/img/logo-light.png">
                            <h6 class="uppercase mb32">Modular Design For Absolute Freedom.</h6>
...
<section class="bg-primary background-multiply pt240 pb240 pt-xs-120 pb-xs-120 overlay image-bg parallax">
    <div class="background-image-holder">
        <img alt="image" class="background-image" src="../assets/img/home24.jpg">
    </div>
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 text-center">
                <img alt="Logo" class="image-small mb40 mb-xs-0" src="../assets/img/logo-light.png">
...
<section id="variant-slider-3" class="vim" vbp="header,fullscreen,form" vbr="Fullscreen Form" icons="mailchimp-cmonitor">
    <section class="cover fullscreen overlay parallax">
        <div class="background-image-holder">
            <img alt="image" class="background-image" src="../assets/img/home13.jpg">
        </div>
        <div class="container v-align-transform">
            <div class="row">
...
<section id="variant-slider-4" class="vim" vbp="header" vbr="Image Logo">
    <section class="pt240 pb240 parallax image-bg overlay bg-light">
        <div class="background-image-holder">
            <img alt="image" class="background-image" src="../assets/img/home19.jpg">
        </div>
        <div class="container">
            <div class="row">
                <div class="col-sm-12 text-center">
                    <img alt="Pic" src="../assets/img/logo-dark.png" class="image-small">
                </div>
            </div>
...
<section id="variant-slider-5" class="vim" vbp="header,fullscreen,video" vbr="Fullscreen Image Text" icons="youtube-vimeo">
    <section class="fullscreen image-bg">
        <div class="background-image-holder">
            <img alt="image" class="background-image" src="../assets/img/vent1.jpg">
        </div>
        <div class="container v-align-transform">
            <div class="row">
                <div class="col-sm-8 col-md-6 mb24">
                    <h6 class="uppercase">Adventure Travel With Heart</h6>
                    <img alt="Pic" src="../assets/img/vent1.png">
                </div>
                <div class="col-sm-12">
...
<section id="variant-slider-6" class="vim" vbp="header,fullscreen" vbr="Image & Paragraph">
    <section class="cover fullscreen image-slider slider-arrow-controls controls-inside parallax">
        <ul class="slides">
            <li class="overlay image-bg">
                <div class="background-image-holder">
                    <img alt="image" class="background-image" src="../assets/img/resto1.jpg">
                </div>
                <div class="container v-align-transform">
                    <div class="row">
                        <div class="col-sm-12 text-center">
                            <img alt="Logo" class="image-small" src="../assets/img/logo-light.png">
                        </div>
                    </div>
...
<section id="variant-slider-7" class="vim" vbp="header,fullscreen" vbr="Color Treated">
    <section class="fullscreen image-bg parallax background-multiply">
        <div class="background-image-holder">
            <img alt="image" class="background-image" src="../assets/img/capital5.jpg">
        </div>
        <div class="container v-align-transform">
            <div class="row">
                <div class="col-sm-12">
...
<section id="variant-slider-8" class="vim" vbp="header,video" vbr="Text & Video" icons="youtube-vimeo">
    <section class="pt120 pb120 image-bg overlay">
        <div class="background-image-holder">
            <img alt="Background" class="background-image" src="../assets/img/event1.jpg">
        </div>
        <div class="container">
...
<section id="variant-slider-9" class="vim" vbp="header,fullscreen,form" vbr="Product Image" icons="mailchimp-cmonitor">
    <section class="bg-primary pb0">
        <div class="container pt80">
            ...
            <div class="row">
                <img alt="image" src="../assets/img/app1.png">
            </div>
...
<section id="variant-slider-10" class="vim" vbp="header,fullscreen" vbr="Bottom Button">
    <section class="cover fullscreen image-bg overlay parallax">
        <div class="background-image-holder">
            <img alt="image" class="background-image" src="../assets/img/prop1.jpg">
        </div>
        <div class="container v-align-transform">
            <div class="row">
                <div class="col-sm-12 text-center">
    ...
    <section class="cover fullscreen image-slider slider-arrow-controls kenburns">
        <ul class="slides">                  
            <li class="image-bg pt-xs-240 pb-xs-240">
                <div class="background-image-holder">
                    <img alt="image" class="background-image" src="../assets/img/burns2.jpg">
                </div>
			...
			<div class="row">
				<div class="col-md-6 col-md-push-3 text-center">
					<div class="image-slider slider-paging-controls controls-outside">
						<ul class="slides">
							<li class="mb32">
								<img alt="App" src="../assets/img/app5.png">
							</li>
							<li class="mb32">
								<img alt="App" src="../assets/img/app5.png">
							</li>
    ...
    <section class="cover fullscreen image-slider slider-all-controls">
        <ul class="slides">
            ...
            <li class="image-bg overlay">
                <div class="background-image-holder">
                    <img alt="Background Image" class="background-image" src="../assets/img/home5.jpg">
                </div>
                <div class="container v-align-transform">
                    <div class="row">
                        <div class="col-sm-12 text-center">
            ...
            <li class="image-bg overlay">
                <div class="background-image-holder">
                    <img alt="Background Image" class="background-image" src="../assets/img/home4.jpg">
                </div>
                <div class="container v-align-transform">
                    <div class="row">
                        <div class="col-sm-12 text-center">
...
<section id="variant-banner-1" class="vim" vbp="header" vbr="w/ App Store Link">
	<section class="image-bg parallax pt240 pb180 pt-xs-80 pb-xs-80">
		<div class="background-image-holder">
			<img alt="image" class="background-image" src="../assets/img/app8.jpg">
		</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-sm-12">
					...
					<a href="#">
						<img class="image-xs" alt="App Store" src="../assets/img/appstore.png">
					</a>
				</div>
			</div>
...
<section id="variant-banner-2" class="vim" vbp="header" vbr="Personal">
	<section class="image-bg overlay pt240 pb240 pt-xs-180 pb-xs-180">
		<div class="background-image-holder">
			<img alt="image" class="background-image" src="../assets/img/fitness3.jpg">
		</div>
		<div class="container">
			<div class="row">
				<div class="col-sm-6">
    ...
    <section class="image-slider slider-all-controls parallax controls-inside pt0 pb0">
        <ul class="slides">
            <li class="overlay image-bg pt240 pb240 pt-xs-120 pb-xs-120">
                <div class="background-image-holder">
                    <img alt="image" class="background-image" src="../assets/img/fashion1.jpg">
                </div>
                <div class="container">
                    <div class="row text-center">
                        <div class="col-md-12">
...
<section id="variant-title-2" class="vim" vbp="Page Title" vbr="Left Aligned Image">
    <section class="page-title page-title-4 image-bg overlay parallax">
        <div class="background-image-holder">
            <img alt="Background Image" class="background-image" src="../assets/img/cover14.jpg">
        </div>
        <div class="container">
            <div class="row">
                <div class="col-md-6">
...
<section id="variant-title-4" class="vim" vbp="Page Title" vbr="Left Aligned Large Image">
    <section class="page-title page-title-2 image-bg overlay parallax">
        <div class="background-image-holder">
            <img alt="Background Image" class="background-image" src="../assets/img/cover15.jpg">
        </div>
        <div class="container">
            <div class="row">
                <div class="col-md-6">
...
<section id="variant-textimage-1" class="vim" vbp="Text + Image" vbr="Image Edge Left">
    <section class="image-edge toggle-bg-mrv">
        <div class="col-md-6 col-sm-4 p0">
            <img alt="Screenshot" class="mb-xs-24" src="../assets/img/phone1.png">
        </div>
        <div class="container">
...
<section id="variant-textimage-2" class="vim" vbp="Text + Image" vbr="Image Edge Right">
    <section class="image-edge">
        <div class="col-md-6 col-sm-4 p0 col-md-push-6 col-sm-push-8">
            <img alt="Screenshot" class="mb-xs-24" src="../assets/img/phone2.png">
        </div>
        <div class="container">
...
<section id="variant-textimage-12" class="vim" vbp="Text + Image,new" vbr="Image Edge Left 2" icons="new">
    <section class="image-edge pt120 pb120 pt-xs-40 pb-xs-40">
        <div class="col-md-6 col-sm-4 p0">
            <img alt="Screenshot" class="mb-xs-24" src="../assets/img/app4.jpg">
        </div>
        <div class="container">
            <div class="col-md-5 col-md-offset-1 col-sm-7 col-sm-offset-1 v-align-transform right">
...
<section id="variant-textimage-13" class="vim" vbp="Text + Image,new" vbr="Image Edge Right 2" icons="new">
    <section class="image-edge pt120 pb120 pt-xs-40 pb-xs-40">
        <div class="col-md-6 col-sm-4 p0 col-md-push-6 col-sm-push-8">
            <img alt="Screenshot" class="cast-shadow mb-xs-24" src="../assets/img/app3.jpg">
        </div>
        <div class="container">
            <div class="col-md-5 col-md-pull-0 col-sm-7 col-sm-pull-4 v-align-transform">
        ...
        <div class="container">
            <div class="row v-align-children">
                <div class="col-md-7 col-sm-6 text-center mb-xs-24">
                    <img class="cast-shadow" alt="Screenshot" src="../assets/img/screenshot.jpg">
                </div>
        ...
        <div class="container">
            <div class="row v-align-children">
                ...
                <div class="col-md-7 col-md-offset-1 col-sm-6 col-sm-offset-1 text-center">
                    <img class="cast-shadow" alt="Screenshot" src="../assets/img/screenshot2.jpg">
                </div>
            </div>
...
<section id="variant-textimage-5" class="vim" vbp="Text + Image" vbr="Image Block Left">
    <section class="image-square left toggle-bg-mrv">
        <div class="col-md-6 image">
            <div class="background-image-holder">
                <img alt="image" class="background-image" src="../assets/img/small1.jpg">
            </div>
        </div>
...
<section id="variant-textimage-6" class="vim" vbp="Text + Image" vbr="Image Block Right">
    <section class="image-square right toggle-bg-mrv">
        <div class="col-md-6 image">
            <div class="background-image-holder">
                <img alt="image" class="background-image" src="../assets/img/small2.jpg">
            </div>
        </div>
    ...
    <section>
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-5">
                    <img class="mt80 mt-xs-0 mb24" alt="Pic" src="../assets/img/resto5.jpg">
                    <img class="col-md-pull-4 relative" alt="Pic" src="../assets/img/resto6.jpg">
                </div>
            </div>
		...
		<div class="container">
			<div class="row v-align-children">
				...
				<div class="col-sm-5 col-sm-6 col-sm-offset-1 text-center">
					<img alt="Screenshot" src="../assets/img/app7.png">
				</div>
			</div>
...
<section id="variant-textimage-9" class="vim" vbp="Text + Image" vbr="Paragraph over Image">
	<section class="image-bg overlay parallax pt180 pb180 pt-xs-80 pb-xs-80">
		<div class="background-image-holder">
			<img alt="image" class="background-image" src="../assets/img/app9.jpg">
		</div>
            ...
            <div class="row mb64 mb-xs-32">
                <div class="col-sm-6">
                    <div class="image-caption cast-shadow mb-xs-32" vht="parent">
                        <img alt="Captioned Image" src="../assets/img/home7.jpg">
                        <div class="caption">
                            <p>
                ...
                <div class="col-sm-6">
                    <div class="image-caption cast-shadow hover-caption" vht="parent">
                        <img alt="Captioned Image" src="../assets/img/home8.jpg">
                        <div class="caption">
                            <p>
               ...
               <div class="col-md-8 col-sm-10 col-sm-offset-1 col-md-offset-2">
                    <div class="horizontal-tile vpe">
                        <div class="tile-left">
                            <a href="#">
                                <div class="background-image-holder">
                                    <img alt="image" class="background-image" src="../assets/img/project-single-1.jpg">
                                </div>
                            </a>
                        </div>
                    ...
                    <div class="horizontal-tile vpe">
                        <div class="tile-left">
                            <a href="#">
                                <div class="background-image-holder">
                                    <img alt="image" class="background-image" src="../assets/img/project-single-3.jpg">
                                </div>
                            </a>
                        </div>
                        <div class="tile-right bg-secondary">
...
<section id="variant-icons-5" class="vim" vbp="Icons" vbr="Icons On Image">
    <section class="image-bg overlay parallax">
        <div class="background-image-holder">
            <img alt="Background" class="background-image" src="../assets/img/cover1.jpg">
        </div>
        <div class="container">
            <div class="row">
                <div class="col-sm-12 text-center">
                    ...
                    <ul class="tabs thirds mb64 mb-xs-24">
                            ...
                            <div class="tab-content text-left">
                                <div>
                                    <div class="overflow-hidden">
                                        <img alt="Pic" class="mb24 pull-left" src="../assets/img/avatar1.png">
                                ...
                                <div>
                                    <div class="overflow-hidden">
                                        <img alt="Pic" class="mb24 pull-left" src="../assets/img/avatar2.png">
                                        <div class="pull-left p32 p0-xs pt24">
                        ...
                        <li>
                            ...
                            <div class="tab-content text-left">
                                <div>
                                    <div class="overflow-hidden">
                                        <img alt="Pic" class="mb24 pull-left" src="../assets/img/avatar3.png">
                                        <div class="pull-left p32 p0-xs pt24">
                                ...
                                <div>
                                    <div class="overflow-hidden">
                                        <img alt="Pic" class="mb24 pull-left" src="../assets/img/avatar4.png">
                                        <div class="pull-left p32 p0-xs pt24">
                        ...
                        <li>
                            ...
                            <div class="tab-content text-left">
                                <div>
                                    <div class="overflow-hidden">
                                        <img alt="Pic" class="mb24 pull-left" src="../assets/img/avatar5.png">
                                        <div class="pull-left p32 p0-xs pt24">
                                ...
                                <div>
                                    <div class="overflow-hidden">
                                        <img alt="Pic" class="mb24 pull-left" src="../assets/img/avatar6.png">
                                        <div class="pull-left p32 p0-xs pt24">
        ...
        <div class="container">
            <div class="col-md-5 col-md-pull-0 col-sm-7 col-sm-pull-4 v-align-transform">
                ...
                <div class="feature boxed">
                    ...
                    <div class="spread-children">
                        <img alt="Pic" class="image-xs" src="../assets/img/avatar1.png">
                        <span>Anne Bracken - Themeforest</span>
                    </div>
                </div>
            </div>
...
<section id="variant-testimonial-2" class="vim" vbp="Testimonial,slider" vbr="Testimonial Slider">
     <section class="image-bg overlay parallax">
        <div class="background-image-holder">
            <img alt="image" class="background-image" src="../assets/img/app2.jpg">
        </div>
        <div class="container">
            <div class="row mb40 mb-xs-24">
                <div class="col-sm-12 text-center spread-children">
                    <img class="image-xs" alt="Pic" src="../assets/img/avatar1.png">
                    <img class="image-xs" alt="Pic" src="../assets/img/avatar2.png">
                    <img class="image-xs" alt="Pic" src="../assets/img/avatar3.png">
                </div>
            </div>
                    ...
                    <div class="testimonials text-slider slider-arrow-controls">
                        <ul class="slides">
                            <li>
                                <p class="lead">It's clear to see just how seriously these guys take design. I've never come across a template with the level of polish as this - and don't even get me started on the page builder, there is simply NO competition. Customer for life.</p>
                                <div class="quote-author">
                                    <img alt="Avatar" src="../assets/img/avatar1.png">
                            ...
                            <li>
                                <p class="lead">I love the ease-of-use the builder provides - I can quickly test different combinations and experiment with font and color combinations to find that sweet spot. Kudos for the amazing support too, really quick turnaround!</p>
                                <div class="quote-author">
                                    <img alt="Avatar" src="../assets/img/avatar2.png">
                            ...
                            <li>
                                <p class="lead">A fine example of atomic design brought to life. As a seasoned template user, I really appreciate the consistent styling for all common tags, it makes customising the sections that much easier. 5 stars as always for an amazing template.</p>
                                <div class="quote-author">
                                    <img alt="Avatar" src="../assets/img/avatar3.png">
...
<section id="variant-testimonial-5" class="vim" vbp="Testimonial" vbr="Testimonial on Image">
     <section class="image-bg bg-light parallax overlay pt160 pb160 pt-xs-80 pb-xs-80">
        <div class="background-image-holder">
            <img alt="image" class="background-image" src="../assets/img/intro1.jpg">
        </div>
        <div class="container">
            <div class="row">
                    ...
                    <div class="text-slider slider-paging-controls text-center relative">
                        <ul class="slides">
                            <li>
                                ...
                                <div class="quote-author">
                                    <img alt="Author" class="image-xs mb16" src="../assets/img/avatar4.png">
                                    <h6 class="uppercase mb0">Anna Thompson</h6>
                                    <span>Vault</span>
                                </div>
                            </li>
                            <li>
                                ...
                                <div class="quote-author">
                                    <img alt="Author" class="image-xs mb16" src="../assets/img/avatar3.png">
                            ...
                            <li>
                                ...
                                <div class="quote-author">
                                    <img alt="Author" class="image-xs mb16" src="../assets/img/avatar6.png">
...
<section id="variant-cta-1" class="vim" vbp="CTA" vbr="CTA on Image">
     <section class="image-bg parallax overlay">
        <div class="background-image-holder">
            <img alt="Background Image" class="background-image" src="../assets/img/home2.jpg">
        </div>
        <div class="container">
            <div class="row mb64 mb-xs-24">
                <div class="col-sm-6 col-md-5 text-right text-center-xs">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12 text-center spread-children-large">
                        <img alt="pic" class="image-xxs mb-xs-8 fade-1-4" src="../assets/img/c1.png">
                        <img alt="pic" class="image-xxs mb-xs-8 fade-1-4" src="../assets/img/c2.png">
                        <img alt="pic" class="image-xxs mb-xs-8 fade-1-4" src="../assets/img/c3.png">
                        <img alt="pic" class="image-xxs mb-xs-8 fade-1-4" src="../assets/img/c4.png">
                    </div>
                </div>
...
<section id="variant-cta-3" class="vim" vbp="CTA" vbr="CTA with Avatars">
     <section class="bg-secondary toggle-bg-mrv">
        <div class="container">
            <div class="row mb64 mb-xs-24">
                <div class="col-sm-12 text-center spread-children-large">
                    <img alt="Pic" src="../assets/img/avatar1.png">
                    <img alt="Pic" src="../assets/img/avatar2.png">
                    <img alt="Pic" src="../assets/img/avatar3.png">
                    <img alt="Pic" src="../assets/img/avatar4.png">
                    <img alt="Pic" src="../assets/img/avatar5.png">
                </div>
            </div>
        ...
        <div class="container">
            <div class="row mb48 mb-xs-24">
                <div class="col-md-6 col-md-offset-3 col-sm-10 col-sm-offset-1 text-center">
                    <img alt="Pic" class="mb16" src="../assets/img/vent2.png">
...
<section id="variant-cta-7" class="vim" vbp="CTA" vbr="CTA w/ Product shot">
	 <section class="bg-dark pb0">
		<div class="container">
			...
			<div class="row">
				<div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2 text-center">
					<img alt="App" src="../assets/img/app6.png">
				</div>	
			</div>
		</div>
	</section>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="image-slider slider-all-controls controls-inside">
                        <ul class="slides">
                            <li>
                                <img alt="Image" src="../assets/img/cover14.jpg">
                            </li>
                            <li>
                                <img alt="Image" src="../assets/img/cover15.jpg">
                            </li>
                            <li>
                                <img alt="Image" src="../assets/img/cover16.jpg">
                            </li>
                        </ul>
                    </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="lightbox-grid square-thumbs lightbox-gallery-mrv" data-gallery-title="Gallery">
                        <ul>
                            <li class="veo voh">
                                <a href="../assets/img/cover1.jpg" class="ven" data-lightbox="true" vht="parent">
                                    <div class="background-image-holder">
                                        <img alt="image" class="background-image" src="../assets/img/cover1.jpg">
                                    </div>
                                </a>
                            </li>
                            <li class="veo voh">
                                <a href="../assets/img/home12.jpg" class="ven" data-lightbox="true" vht="parent">
                                    <div class="background-image-holder">
                                        <img alt="image" class="background-image" src="../assets/img/home12.jpg">
                                    </div>
                                </a>
                            </li>
                            <li class="veo voh">
                                <a href="../assets/img/home14.jpg" class="ven" data-lightbox="true" vht="parent">
                                    <div class="background-image-holder">
                                        <img alt="image" class="background-image" src="../assets/img/home14.jpg">
                                    </div>
                                </a>
                            </li>
                            <li class="veo voh">
                                <a href="../assets/img/home17.jpg" class="ven" data-lightbox="true" vht="parent">
                                    <div class="background-image-holder">
                                        <img alt="image" class="background-image" src="../assets/img/home17.jpg">
                                    </div>
                                </a>
                            </li>
                            <li class="veo voh">
                                <a href="../assets/img/cover5.jpg" class="ven" data-lightbox="true" vht="parent">
                                    <div class="background-image-holder">
                                        <img alt="image" class="background-image" src="../assets/img/cover5.jpg">
                                    </div>
                                </a>
                            </li>
                            <li class="veo voh">
                                <a href="../assets/img/cover6.jpg" class="ven" data-lightbox="true" vht="parent">
                                    <div class="background-image-holder">
                                        <img alt="image" class="background-image" src="../assets/img/cover6.jpg">
                                    </div>
                                </a>
                            </li>
                            <li class="veo voh">
                                <a href="../assets/img/cover7.jpg" class="ven" data-lightbox="true" vht="parent">
                                    <div class="background-image-holder">
                                        <img alt="image" class="background-image" src="../assets/img/cover7.jpg">
                                    </div>
                                </a>
                            ...
                            <li class="veo voh">
                                <a href="../assets/img/cover8.jpg" class="ven" data-lightbox="true" vht="parent">
                                    <div class="background-image-holder">
                                        <img alt="image" class="background-image" src="../assets/img/cover8.jpg">
                                    </div>
                                </a>
                            </li>
                        </ul>
...
<section id="variant-countdown-1" class="vim" vbp="Countdown" vbr="Countdown with Form" icons="mailchimp-cmonitor">
     <section class="cover fullscreen image-bg overlay">
        <div class="background-image-holder">
            <img alt="image" class="background-image" src="../assets/img/cover13.jpg">
        </div>
        <div class="container v-align-transform">
            <div class="row">
                <div class="col-sm-12">
            ...
            <div class="row v-align-children">
                <div class="col-md-7 col-sm-6 text-center mb-xs-24">
                    <div class="local-video-container">
                        <div class="background-image-holder">
                            <img alt="Background Image" class="background-image" src="../assets/img/home3.jpg">
                        </div>
                        <video controls="">
                            <source src="../video/video.webm" type="video/webm">
                                </source><source src="../video/video.mp4" type="video/mp4">
...
<section id="variant-video-3" class="vim" vbp="video" vbr="Inline Video w/ Description">
    <section class="bg-primary">
        <div class="container">
            ...
            <div class="row mb48 mb-xs-24">
                <div class="col-sm-8 col-sm-offset-2">
                    <div class="local-video-container mb40">
                        <div class="background-image-holder">
                            <img alt="Background Image" class="background-image" src="../assets/img/capital3.jpg">
                        </div>
                        <video controls="">
                            <source src="../video/video.webm" type="video/webm">
                            </source><source src="../video/video.mp4" type="video/mp4">
            ...
            <div class="row">
                <div class="col-sm-12 text-center spread-children-large">
                    <img alt="pic" class="image-xxs mb-xs-8 fade-half" src="../assets/img/c1.png">
                    <img alt="pic" class="image-xxs mb-xs-8 fade-half" src="../assets/img/c2.png">
                    <img alt="pic" class="image-xxs mb-xs-8 fade-half" src="../assets/img/c3.png">
                    <img alt="pic" class="image-xxs mb-xs-8 fade-half" src="../assets/img/c4.png">
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-4 col-sm-6">
                    <div class="image-tile outer-title text-center" vht="parent">
                        <img alt="Pic" src="../assets/img/team-1.jpg">
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="image-tile outer-title text-center" vht="parent">
                        <img alt="Pic" src="../assets/img/team-2.jpg">
                        <div class="title mb16">
        ...
        <div class="container">
            <div class="feed-item mb96 mb-xs-48">
                ...
                <div class="row mb32 mb-xs-16">
                    <div class="col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1">
                        <img alt="Article Image" class="mb32 mb-xs-16" src="../assets/img/blog-single.jpg">
                        <p class="lead">
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-5 col-sm-7">
					...
					<img alt="signature" src="../assets/img/fitness1.png" class="image-small">
				</div>
			</div>
		</div>
	</section>
            ...
            <div class="row">
                <div class="col-sm-10 col-sm-offset-1">
                    <div class="post-snippet mb64">
                        <img class="mb24" alt="Post Image" src="../assets/img/blog-single.jpg">
        ...
        <div class="row">
            <div class="logo-carousel">
                <ul class="slides">
                    <li>
                        <a href="#" vht="parent">
                            <img alt="Logo" src="../assets/img/l1.png" vht="li">
                        </a>
                    </li>
                    <li>
                        <a href="#" vht="parent">
                            <img alt="Logo" src="../assets/img/l2.png" vht="li">
                        </a>
                    </li>
                    <li>
                        <a href="#" vht="parent">
                            <img alt="Logo" src="../assets/img/l3.png" vht="li">
                        </a>
                    </li>
                    <li>
                        <a href="#" vht="parent">
                            <img alt="Logo" src="../assets/img/l4.png" vht="li">
                        </a>
                    </li>
                    <li>
                        <a href="#" vht="parent">
            ...
            <div class="row masonry masonryFlyIn">
                <div class="col-sm-6 masonry-item project" data-filter="People">
                    <div class="image-tile hover-tile text-center" vht="parent">
                        <img alt="image" class="background-image" src="../assets/img/home17.jpg" vht=".project">
                ...
                <div class="col-sm-6 masonry-item project" data-filter="People">
                    <div class="image-tile hover-tile text-center" vht="parent">
                        <img alt="image" class="background-image" src="../assets/img/home20.jpg" vht=".project">
                        <div class="hover-state">
                            <a href="#">
                ...
                <div class="col-sm-6 masonry-item project" data-filter="People">
                    <div class="image-tile hover-tile text-center" vht="parent">
                        <img alt="image" class="background-image" src="../assets/img/home14.jpg" vht=".project">
                        <div class="hover-state">
                            <a href="#">
                ...
                <div class="col-sm-6 masonry-item project" data-filter="People">
                    <div class="image-tile hover-tile text-center" vht="parent">
                        <img alt="image" class="background-image" src="../assets/img/home18.jpg" vht=".project">
                        <div class="hover-state">
                            <a href="#">
        ...
        <div class="row masonry masonryFlyIn">
            <div class="col-md-4 col-sm-6 masonry-item project voh" data-filter="People">
                <div class="image-tile inner-title hover-reveal text-center">
                    <a href="#">
                        <img alt="Pic" src="../assets/img/project-single-1.jpg" vht=".project">
                        <div class="title">
            ...
            <div class="col-md-4 col-sm-6 masonry-item project voh" data-filter="Animals">
                <div class="image-tile inner-title hover-reveal text-center">
                    <a href="#">
                        <img alt="Pic" src="../assets/img/project-single-2.jpg" vht=".project">
                        <div class="title">
            ...
            <div class="col-md-4 col-sm-6 masonry-item project voh" data-filter="People">
                <div class="image-tile inner-title hover-reveal text-center">
                    <a href="#">
                        <img alt="Pic" src="../assets/img/project-single-3.jpg" vht=".project">
                        <div class="title">
            ...
            <div class="col-md-4 col-sm-6 masonry-item project voh" data-filter="Objects">
                <div class="image-tile inner-title hover-reveal text-center">
                    <a href="#">
                        <img alt="Pic" src="../assets/img/project-single-5.jpg" vht=".project">
                        <div class="title">
            ...
            <div class="col-md-4 col-sm-6 masonry-item project voh" data-filter="Objects">
                <div class="image-tile inner-title hover-reveal text-center">
                    <a href="#">
                        <img alt="Pic" src="../assets/img/project-single-4.jpg" vht=".project">
                        <div class="title">
            ...
            <div class="col-md-4 col-sm-6 masonry-item project voh" data-filter="People">
                <div class="image-tile inner-title hover-reveal text-center">
                    <a href="#">
                        <img alt="Pic" src="../assets/img/project-single-6.jpg" vht=".project">
                        <div class="title">
        ...
        <div class="container">
            <div class="row row-gapless masonry masonryFlyIn">
                <div class="col-md-4 col-sm-6 masonry-item project" data-filter="People">
                    <div class="image-tile inner-title hover-reveal text-center">
                        <a href="#">
                            <img alt="Pic" src="../assets/img/project-single-1.jpg">
                            <div class="title">
                                <h5 class="uppercase mb0">Happy Couple</h5>
                                <span>People / Life</span>
                            </div>
                ...
                <div class="col-md-4 col-sm-6 masonry-item project" data-filter="Animals">
                    <div class="image-tile inner-title hover-reveal text-center">
                        <a href="#">
                            <img alt="Pic" src="../assets/img/project-single-2.jpg">
                            <div class="title">
                                <h5 class="uppercase mb0">Lonely Dog</h5>
                                <span>Animals / Art</span>
                            </div>
                ...
                <div class="col-md-4 col-sm-6 masonry-item project" data-filter="People">
                    <div class="image-tile inner-title hover-reveal text-center">
                        <a href="#">
                            <img alt="Pic" src="../assets/img/project-single-3.jpg">
                            <div class="title">
                                <h5 class="uppercase mb0">Pondering Blonde</h5>
                                <span>People / Life</span>
                            </div>
                ...
                <div class="col-md-4 col-sm-6 masonry-item project" data-filter="Objects">
                    <div class="image-tile inner-title hover-reveal text-center">
                        <a href="#">
                            <img alt="Pic" src="../assets/img/project-single-5.jpg">
                            <div class="title">
                                <h5 class="uppercase mb0">Vintage Typewriter</h5>
                                <span>Objects / Isolated</span>
                            </div>
                ...
                <div class="col-md-4 col-sm-6 masonry-item project" data-filter="Objects">
                    <div class="image-tile inner-title hover-reveal text-center">
                        <a href="#">
                            <img alt="Pic" src="../assets/img/project-single-4.jpg">
                            <div class="title">
                                <h5 class="uppercase mb0">Summer Lovin'</h5>
                                <span>Objects / Food</span>
                            </div>
                ...
                <div class="col-md-4 col-sm-6 masonry-item project" data-filter="People">
                    <div class="image-tile inner-title hover-reveal text-center">
                        <a href="#">
                            <img alt="Pic" src="../assets/img/project-single-6.jpg">
                            <div class="title">
                                <h5 class="uppercase mb0">Thick Fog</h5>
                                <span>People / Life</span>
                            </div>
...
<section id="variant-image-4" class="vim" vbp="portfolio" vbr="Wide Project">
    <section class="image-bg bg-dark parallax overlay pt120 pb120">
        <div class="background-image-holder">
            <img alt="Background Image" class="background-image" src="../assets/img/project-single-3.jpg">
        </div>
        <div class="container">
            <div class="row">
                <div class="col-sm-12 text-center">
...
<section id="variant-coming-soon-1" class="vim" vbp="form" vbr="Coming Soon">
	<section class="cover fullscreen image-bg overlay">
        <div class="background-image-holder">
            <img alt="image" class="background-image" src="../assets/img/page-coming-soon.jpg">
        </div>
        <div class="container v-align-transform">
            <div class="row">
				...
				<div class="row mb24 mb-xs-48">
					<div class="col-md-5 col-sm-6">
						<div class="image-slider slider-thumb-controls controls-inside">
							...
							<ul class="slides">
								<li>
									<img alt="Image" src="../assets/img/shop-product-4.jpg">
								</li>
								<li>
									<img alt="Image" src="../assets/img/shop-product-4_1.jpg">
								</li>
								<li>
									<img alt="Image" src="../assets/img/shop-product-4_2.jpg">
								</li>
							</ul>
						</div>
    ...
    <nav>
        <div class="nav-bar">
            <div class="module left">
                <a href="index.html">
                    <img class="logo logo-light" alt="Foundry" src="../assets/img/logo-light.png">
    ...
    <nav>
        ...
        <div class="nav-bar text-center">
            <div class="col-md-2 col-md-push-5 col-sm-12 text-center">
                <a href="#">
                    <img alt="logo" class="image-xxs" src="../assets/img/logo-dark.png">
                </a>
            </div>
    ...
    <nav class="absolute transparent">
            ...
            <div class="offscreen-container bg-dark text-center vog">
                ...
                <div class="v-align-transform text-center">
                    <a href="#"><img alt="Logo" class="image-xs mb40 mb-xs-24" src="../assets/img/logo-light.png"></a>
...
<section id="variant-footer-2" class="vim" vbs="footer" vbp="misc" vbr="Slim Footer">			
	<footer class="footer-2 bg-dark toggle-bg-mrv text-center-xs">
		<div class="container">
			<div class="row">
				<div class="col-sm-4">
					<a href="#"><img class="image-xxs fade-half" alt="Pic" src="../assets/img/logo-light.png"></a>
				</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2 text-center mb64 mb-xs-24">
					<a href="#">
						<img alt="Logo" class="image-xs mb16" src="../assets/img/logo-light.png">
					</a>
	...
	<footer class="footer-2 bg-dark toggle-bg-mrv pt96 pt-xs-40">
		<div class="container">
			<div class="row mb64 mb-xs-24">
				<div class="col-sm-12">
					<a href="#">
						<img alt="logo" class="image-xxs" src="../assets/img/logo-light.png">
					</a>
				</div>
			</div>
			<div class="row mb64 mb-xs-24">
